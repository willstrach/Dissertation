...
The context required for disambiguation exists in the STS. Two algorithms for disambiguation using this context have been implemented, one using hyponyms and one using hypernyms.
