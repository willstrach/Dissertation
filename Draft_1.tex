...
\subsection{Project Aims}
\label{EvAims}
In section \ref{sec:ProjectAim}, three aims for the project were established.

\subsubsection{A computational model of memory structures}
\label{EvAims1}
The memory structures implemented are modelled on those described by Baddeley \cite{MemoryBaddeleyEysenkAnderson}.

\subsubsection{A system for reading in a corpus}
\label{EvAims2}

\subsubsection{A computational model of disambiguation}
\label{EvAims2}
